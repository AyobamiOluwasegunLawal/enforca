                ...
                <div className={'max-w-[1400px] mt-32 mx-auto lg:mt-40 xl:mt-52'}>
                    ...
                    <div className={'text-black px-4 flex flex-col   gap-7 xs:px-8 sm:max-w-xl sm:mx-auto lg:mx-0'}>
                        ...
                        <div className={'flex flex-col xs:flex-row xs:justify-center sm:justify-start lg:justify-start gap-5 max-sm:mb-10'}>
                            <Link to={'/Contact'} className={'px-9 py-3 font-bold rounded-full bg-transparent border-1 border-primary hover:bg-primary hover:text-white transition duration-100 ease-in text-black'}>Contact us</Link>
                            <a href="mailto:info@mentor-techies.com" className={'px-9 py-3 rounded-full sm:block bg-primary font-bold text-white outline-none cursor-pointer w-fit'}>Send Email</a>
                        </div>
                    </div>
                </div>
            </div>
